...
public class Matrix {
    ...
    public static Matrix createRotationX_4x4(float radians, Vector center) {
        Matrix result = new Matrix(4, 4);

        float cos = (float)Math.cos(radians);
        float sin = (float)Math.sin(radians);
        float y = center.get(1) * (1 - cos) + center.get(2) * sin;
        float z = center.get(2) * (1 - cos) - center.get(1) * sin;
    ...
    public static Matrix createRotationY_4x4(float radians, Vector center) {
        Matrix result = new Matrix(4, 4);

        float cos = (float)Math.cos(radians);
        float sin = (float)Math.sin(radians);
        float x = center.get(0) * (1 - cos) + center.get(2) * sin;
        float z = center.get(2) * (1 - cos) - center.get(1) * sin;
    ...
    public static Matrix createRotationZ_4x4(float radians, Vector center) {
        Matrix result = new Matrix(4, 4);
